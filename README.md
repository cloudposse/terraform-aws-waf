...
| <a name="module_kinesis_iam_role"></a> [kinesis\_iam\_role](#module\_kinesis\_iam\_role) | git@github.com:humn-ai/tf-mod-aws-iam-role | tags/0.0.3 |
...
| <a name="input_policy_config"></a> [policy\_config](#input\_policy\_config) | (Optional) - A list of objects that contain configuration for each policy required | <pre>list(object({<br>    name        = string<br>    description = string<br>    path        = string<br>    policy      = string<br>  }))</pre> | `[]` | no |
