...
# tf-mod-aws-waf [![Latest Release](https://img.shields.io/github/release/cloudposse/terraform-aws-waf.svg)](https://github.com/cloudposse/terraform-aws-waf/releases/latest) [![Slack Community](https://slack.cloudposse.com/badge.svg)](https://slack.cloudposse.com)
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_kinesis"></a> [kinesis](#module\_kinesis) | cloudposse/label/null | 0.25.0 |
...
| Name | Type |
|------|------|
| [aws_kinesis_firehose_delivery_stream.default](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/kinesis_firehose_delivery_stream) | resource |
...
| <a name="input_bucket_arn"></a> [bucket\_arn](#input\_bucket\_arn) | (Required) - The ARN of the S3 bucket. | `string` | n/a | yes |
...
| <a name="input_role_arn"></a> [role\_arn](#input\_role\_arn) | (Required) - The ARN of the role that provides access to the source Kinesis stream. | `string` | n/a | yes |
...
<!-- markdownlint-disable -->
|  [![Vladimir Syromyatnikov][SweetOps_avatar]][SweetOps_homepage]<br/>[Vladimir Syromyatnikov][SweetOps_homepage] | [![Callum Robertson][Callumccr_avatar]][Callumccr_homepage]<br/>[Callum Robertson][Callumccr_homepage] |
|---|---|
<!-- markdownlint-restore -->
...
[![Beacon][beacon]][website]
  ...
  [share_twitter]: https://twitter.com/intent/tweet/?text=tf-mod-aws-waf&url=https://github.com/cloudposse/terraform-aws-waf
  [share_linkedin]: https://www.linkedin.com/shareArticle?mini=true&title=tf-mod-aws-waf&url=https://github.com/cloudposse/terraform-aws-waf
  ...
  [share_email]: mailto:?subject=tf-mod-aws-waf&body=https://github.com/cloudposse/terraform-aws-waf
